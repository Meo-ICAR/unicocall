...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('purchase_invoices', function (Blueprint $table) {
            ...
            $table->date('data_ricezione')->nullable()->comment('Data di ricezione');
            ...
            $table->string('fornitore')->comment('Nome del fornitore');
            $table->string('partita_iva', 13)->nullable()->comment('Partita IVA del fornitore');
            $table->string('codice_fiscale', 16)->nullable()->comment('Codice Fiscale del fornitore');
            ...
            $table->string('pagamenti')->nullable()->comment('Stato pagamenti');
            $table->date('data_pagamento')->nullable()->comment('Data pagamento');
            ...
            // Indexes
            $table->index(['numero', 'data_documento'], 'purchase_invoices_numero_data_index');
            $table->index(['fornitore'], 'purchase_invoices_fornitore_index');
            $table->index(['partita_iva'], 'purchase_invoices_partita_iva_index');
            $table->index(['data_documento'], 'purchase_invoices_data_documento_index');
            $table->index(['stato'], 'purchase_invoices_stato_index');
        });
    }
