...
class ClientType extends Model
{
    ...
    {
        return $this->hasMany(Client::class)->where('is_active', false);
    }

    public function leadClients(): HasMany
    {
        return $this->hasMany(Client::class)->where('is_lead', true);
    }

    public function actualClients(): HasMany
    {
        return $this->hasMany(Client::class)->where('is_client', true);
    }
