...
class ImportPurchaseInvoicesCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'import:purchase-invoices {company_id} {--file=20260422_ReportFattureRicevute.xls}';
     ...
     * @var string
     */
    protected $description = 'Importa fatture ricevute da file Excel o ZIP per una specifica azienda';

    /**
     * Execute the console command.
     */
    public function handle(PurchaseInvoiceImportService $importService): int
    {
        ...
        $this->info("Inizio importazione fatture ricevute per azienda ID: {$companyId}");
        ...
        // Import the invoices
        $result = $importService->importPurchaseInvoices($filePath, $companyId);
